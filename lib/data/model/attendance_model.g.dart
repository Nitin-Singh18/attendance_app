...
extension AttendanceModelQuerySortBy
  ...
  QueryBuilder<AttendanceModel, AttendanceModel, QAfterSortBy> sortByTime() {
    return QueryBuilder.apply(this, (query) {
...
extension AttendanceModelQuerySortThenBy
  ...
  QueryBuilder<AttendanceModel, AttendanceModel, QAfterSortBy> thenByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }
...
extension AttendanceModelQueryWhereDistinct
  ...
  QueryBuilder<AttendanceModel, AttendanceModel, QDistinct> distinctByTime() {
    return QueryBuilder.apply(this, (query) {
...
extension AttendanceModelQueryProperty
  ...
  QueryBuilder<AttendanceModel, String, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'status');
    });
  }

  QueryBuilder<AttendanceModel, DateTime?, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
